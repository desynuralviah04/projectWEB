...
<head>
  ...
  <link href="<?php echo base_url('assets/user')?>/vendor/fontawesome-free/css/all.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0"><img class="masthead-avatar mb-5" src="<?php echo base_url('assets/user') ?>/img/logopanarukan.png" alt="">Puskesmas Panarukan</h1>
      <div class="row">
      ...
      <?php } ?>
      <?php if(empty($this->session->userdata('id_pasien'))){ ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Puskesmas Panarukan. 
    ...
    <div class="container">  
      <div class="row">
        <div class="col-lg-4.ml-auto" align="center" >
          <p class="lead">Klik Login > Input Sidik Jari > Pilih Poli > Klik Cetak</p>
          <p class="lead">Pasien melakukan Registrasi > Input Nomor Identitas, Nama Pasien, Jenis Kelamin, Usia, Tanggal Lahir, Alamat, Nomor Telephone, Sidik Jari dan Password > Klik Login >  Pilih Poli > Klik Cetak </p>
      </div>
    </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Jl. Raya Wringin Anom No.29 68312  
            <br>Situbondo Jawa Timur</p>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <p class="lead mb-0">+62 338 672443</p>
        </div>
